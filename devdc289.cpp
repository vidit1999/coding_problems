...
int manhattanDistance(pair<int, int> pointA, pair<int, int> pointB){
	return abs(pointA.first - pointB.first) + abs(pointA.second - pointB.second);
}

// main function
int main(){
	cout << manhattanDistance( {1, 1}, {1, 1} ) << "\n";
	cout << manhattanDistance( {5, 4}, {3, 2} ) << "\n";
	cout << manhattanDistance( {1, 1}, {0, 3} ) << "\n";
	cout << manhattanDistance( {1, 2}, {1, 3} ) << "\n";
	cout << manhattanDistance( {5, 2}, {7, 3} ) << "\n";
	cout << manhattanDistance( {1, 2}, {4, 4} ) << "\n";
	return 0;
}